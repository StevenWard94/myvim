...
function! GetErubyIndent(...)
  ...
  if inruby && getline(v:lnum) !~ '^<%\|^\s*[-=]\=%>'
    ...
    execute "let ind = " . b:eruby_subtype_indentexpr

    " workaround for Andy Wokula's HTML indent -- this should be removed
    " after some time, since the newest version is fixed in a different way
