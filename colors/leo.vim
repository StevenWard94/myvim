...
if v:version >= 703
	hi ColorColumn	cterm=none	ctermfg=250		ctermbg=233
endif
...
hi Special			cterm=none		ctermfg=206		ctermbg=233		guifg=#ff5fd7 guibg=#1c1c1c
hi Statement		cterm=none		ctermfg=171		gui=none			guifg=#d75fff
"hi String				cterm=none		ctermfg=224		ctermbg=233		guifg=#ffd7d7	guibg=#1c1c1c
hi String				cterm=none		ctermfg=180		ctermbg=233		guifg=#d7af87	guibg=#1c1c1c
